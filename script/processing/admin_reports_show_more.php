...
while($reports_data = $result->fetch_object()) {
	switch($reports_data->type) {
		...
		case '1' : $reports_data->type = 'Quote'; break;
		case '2' : $reports_data->type = 'User'; break;
	}
?>
<tr>
	...
	<td><a href="admin/edit-report/<?php echo $reports_data->id; ?>"><?php echo $language->admin_reports_management->table->actions; ?></a></td>
</tr>
<?php } ?>
...
<tr id="showMoreReports">
	<td colspan="6">
		<div class="center">
			<button id="showMore" class="btn btn-primary" onClick="showMore(<?php echo $_POST['limit'] + $results_limit; ?>, 'processing/admin_users_show_more.php', '#results', '#showMoreReports');"><?php echo $language->global->show_more; ?></button>
		</div>	
	</td>
</tr>
<?php } ?>
