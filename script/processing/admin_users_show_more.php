...
<tr>
	<td>
		...
		<a href="#" data-toggle="tooltip" title="<?php echo $language->admin_users_management->tooltip->admin; ?>"  class="tooltipz"><span class="glyphicon glyphicon-bookmark"></span></a>
		<?php } elseif($users_data->type == 2) { ?>
		<a href="#" data-toggle="tooltip" title="<?php echo $language->admin_users_management->tooltip->owner; ?>"  class="tooltipz"><span class="glyphicon glyphicon-bookmark"></span></a>
		<?php } ?>
...
<tr id="showMoreUsers">
	<td colspan="6">
		<div class="center">
			<button id="showMore" class="btn btn-primary" onClick="showMore(<?php echo $_POST['limit'] + $results_limit; ?>, 'processing/admin_users_show_more.php', '#results', '#showMoreUsers');"><?php echo $language->global->show_more; ?></button>
		</div>	
	</td>
</tr>
<?php } ?>
